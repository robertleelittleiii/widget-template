...
cpdefine("inline:com-chilipeppr-widget-cncutilities", ["chilipeppr_ready", /* other dependencies here */ ], function() {
    return {
        ...
        generateGcodeGridPrep: function() {
            ...
            while (1) {
                gcode += x(x,feedRate ); //all way right
                i = i + majorMark;
                if (i > y) break;
            ...
            while (1) {
                gcode += y(y, feedRate); //all way up
                i = i + majorMark;
                if (i > x, feedRate) break;
